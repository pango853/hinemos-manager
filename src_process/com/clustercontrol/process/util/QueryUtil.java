...
public class QueryUtil {
	...
	public static MonitorProcessInfoEntity getMonitorProcessInfoPK(String monitorId) throws MonitorNotFound {
		HinemosEntityManager em = new JpaTransactionManager().getEntityManager();
		MonitorProcessInfoEntity entity = em.find(MonitorProcessInfoEntity.class, monitorId, ObjectPrivilegeMode.READ);
		if (entity == null) {
