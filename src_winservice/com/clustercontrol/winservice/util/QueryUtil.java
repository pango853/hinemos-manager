...
public class QueryUtil {
	...
	public static MonitorWinserviceInfoEntity getMonitorWinserviceInfoPK(String monitorId) throws MonitorNotFound {
		HinemosEntityManager em = new JpaTransactionManager().getEntityManager();
		MonitorWinserviceInfoEntity entity = em.find(MonitorWinserviceInfoEntity.class, monitorId, ObjectPrivilegeMode.READ);
		if (entity == null) {
