...
/**
 * IMAPサービスが動作しているかを確認するクラスです。
 * 
 * @version 4.0.0
 * @since 4.0.0
 */
public class ReachAddressIMAP extends ReachAddressProtocol {

	private static Log m_log = LogFactory.getLog(ReachAddressIMAP.class);

	/**
	 * IMAPサービスが動作しているかをテストします
	 * 
	 * @param addressText
	 * @return IMAP監視ステータス
	 */
	...
	protected boolean isRunning(String addressText) {
		...
		try {
			...
			bufferOrg.append("Monitoring the IMAP Service of "
