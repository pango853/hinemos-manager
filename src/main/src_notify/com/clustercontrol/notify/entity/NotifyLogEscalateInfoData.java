 ...
 * @version 4.0.1
 */
public class NotifyLogEscalateInfoData
...
implements java.io.Serializable
{
	...
	private java.lang.Integer validFlg;
	...
	public NotifyLogEscalateInfoData( java.lang.String notifyId,java.lang.Integer priority,java.lang.Integer validFlg,java.lang.String escalateMessage,java.lang.Integer syslogPriority,java.lang.Integer syslogFacility,java.lang.Integer escalateFacilityFlg,java.lang.String escalateFacility,java.lang.Integer escalatePort,java.lang.String ownerRoleId )
	{
	...
	public com.clustercontrol.notify.entity.NotifyLogEscalateInfoPK getPrimaryKey() {
		com.clustercontrol.notify.entity.NotifyLogEscalateInfoPK pk = new com.clustercontrol.notify.entity.NotifyLogEscalateInfoPK(this.getNotifyId(),this.getPriority());
		return pk;
	}
	...
	public java.lang.Integer getValidFlg()
	{
		return this.validFlg;
	}
	public void setValidFlg( java.lang.Integer validFlg )
	{
	...
	public String toString()
	{
		...
		str.append("notifyId=" + getNotifyId() + " " + "priority=" + getPriority() + " " + "validFlg=" + getValidFlg() + " " + "escalateMessage=" + getEscalateMessage() + " " + "syslogPriority=" + getSyslogPriority() + " " + "syslogFacility=" + getSyslogFacility() + " " + "escalateFacilityFlg=" + getEscalateFacilityFlg() + " " + "escalateFacility=" + getEscalateFacility() + " " + "escalatePort=" + getEscalatePort() + " " + "ownerRoleId=" + getOwnerRoleId());
		str.append('}');
