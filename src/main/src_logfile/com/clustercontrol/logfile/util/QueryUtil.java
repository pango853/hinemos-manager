...
public class QueryUtil {
	...
	public static MonitorLogfileInfoEntity getMonitorLogfileInfoPK(String monitorId) throws MonitorNotFound {
		HinemosEntityManager em = new JpaTransactionManager().getEntityManager();
		MonitorLogfileInfoEntity entity = em.find(MonitorLogfileInfoEntity.class, monitorId, ObjectPrivilegeMode.READ);
		if (entity == null) {
