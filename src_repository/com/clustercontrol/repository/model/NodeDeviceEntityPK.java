...
/**
 * The primary key class for the cc_cfg_node_device database table.
 * 
 */
@Embeddable
public class NodeDeviceEntityPK implements Serializable {
	...
	public NodeDeviceEntityPK() {
	}

	public NodeDeviceEntityPK(String facilityId,
			Integer deviceIndex,
			String deviceType,
			String deviceName) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof NodeDeviceEntityPK)) {
			return false;
		}
		NodeDeviceEntityPK castOther = (NodeDeviceEntityPK)other;
		return
