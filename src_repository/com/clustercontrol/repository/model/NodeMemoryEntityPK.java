...
/**
 * The primary key class for the cc_cfg_node_memory database table.
 * 
 */
@Embeddable
public class NodeMemoryEntityPK implements Serializable {
	...
	public NodeMemoryEntityPK() {
	}

	public NodeMemoryEntityPK(String facilityId,
			Integer deviceIndex,
			String deviceType,
			String deviceName) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof NodeMemoryEntityPK)) {
			return false;
		}
		NodeMemoryEntityPK castOther = (NodeMemoryEntityPK)other;
		return
