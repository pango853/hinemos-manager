 ...
 */
@Embeddable
public class NodeDiskEntityPK implements Serializable {
	...
	public NodeDiskEntityPK() {
	}

	public NodeDiskEntityPK(String facilityId,
			Integer deviceIndex,
			String deviceType,
			String deviceName) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof NodeDiskEntityPK)) {
			return false;
		}
		NodeDiskEntityPK castOther = (NodeDiskEntityPK)other;
		return
