...
@Cacheable(true)
public class NodeDiskEntity implements Serializable {
	private static final long serialVersionUID = 1L;
	private NodeDiskEntityPK id;
	...
	@Deprecated
	public NodeDiskEntity() {
	}

	public NodeDiskEntity(NodeDiskEntityPK pk,
	...
	public NodeDiskEntity(NodeEntity nodeEntity,
			Integer deviceIndex,
			String deviceType,
			String deviceName) {
		this(new NodeDiskEntityPK(
	...
	@EmbeddedId
	public NodeDiskEntityPK getId() {
		return this.id;
	}

	public void setId(NodeDiskEntityPK id) {
		this.id = id;
	}
	...
	public Integer getDeviceDiskRpm() {
		return this.deviceDiskRpm;
	}

	public void setDeviceDiskRpm(Integer deviceDiskRpm) {
	...
	public void relateToNodeEntity(NodeEntity nodeEntity) {
		...
		if (nodeEntity != null) {
			List<NodeDiskEntity> list = nodeEntity.getNodeDiskEntities();
			if (list == null) {
				list = new ArrayList<NodeDiskEntity>();
			} else {
				for(NodeDiskEntity entity : list){
			...
			list.add(this);
			nodeEntity.setNodeDiskEntities(list);
		}
	}
	...
	public void unchain() {
		...
		if (this.nodeEntity != null) {
			List<NodeDiskEntity> list = this.nodeEntity.getNodeDiskEntities();
			if (list != null) {
