...
/**
 * The primary key class for the cc_cfg_node_filesystem database table.
 * 
 */
@Embeddable
public class NodeFilesystemEntityPK implements Serializable {
	...
	public NodeFilesystemEntityPK() {
	}

	public NodeFilesystemEntityPK(String facilityId,
			Integer deviceIndex,
			String deviceType,
			String deviceName) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof NodeFilesystemEntityPK)) {
			return false;
		}
		NodeFilesystemEntityPK castOther = (NodeFilesystemEntityPK)other;
		return
