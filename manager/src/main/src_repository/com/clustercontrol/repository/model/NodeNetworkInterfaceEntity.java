...
@Cacheable(true)
public class NodeNetworkInterfaceEntity implements Serializable {
	private static final long serialVersionUID = 1L;
	private NodeNetworkInterfaceEntityPK id;
	...
	@Deprecated
	public NodeNetworkInterfaceEntity() {
	}

	public NodeNetworkInterfaceEntity(NodeNetworkInterfaceEntityPK pk,
	...
	public NodeNetworkInterfaceEntity(NodeEntity nodeEntity,
			Integer deviceIndex,
			String deviceType,
			String deviceName) {
		this(new NodeNetworkInterfaceEntityPK(
	...
	@EmbeddedId
	public NodeNetworkInterfaceEntityPK getId() {
		return this.id;
	}

	public void setId(NodeNetworkInterfaceEntityPK id) {
		this.id = id;
	}
	...
	public String getDeviceNicIpAddress() {
		return this.deviceNicIpAddress;
	}

	public void setDeviceNicIpAddress(String deviceNicIpAddress) {
		this.deviceNicIpAddress = deviceNicIpAddress;
	}


	@Column(name="device_nic_mac_address")
	public String getDeviceNicMacAddress() {
		return this.deviceNicMacAddress;
	}

	public void setDeviceNicMacAddress(String deviceNicMacAddress) {
	...
	public void relateToNodeEntity(NodeEntity nodeEntity) {
		...
		if (nodeEntity != null) {
			List<NodeNetworkInterfaceEntity> list = nodeEntity.getNodeNetworkInterfaceEntities();
			if (list == null) {
				list = new ArrayList<NodeNetworkInterfaceEntity>();
			} else {
				for(NodeNetworkInterfaceEntity entity : list){
			...
			list.add(this);
			nodeEntity.setNodeNetworkInterfaceEntities(list);
		}
	}
	...
	public void unchain() {
		...
		if (this.nodeEntity != null) {
			List<NodeNetworkInterfaceEntity> list = this.nodeEntity.getNodeNetworkInterfaceEntities();
			if (list != null) {
