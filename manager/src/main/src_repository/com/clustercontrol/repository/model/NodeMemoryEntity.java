...
@Cacheable(true)
public class NodeMemoryEntity implements Serializable {
	private static final long serialVersionUID = 1L;
	private NodeMemoryEntityPK id;
	...
	@Deprecated
	public NodeMemoryEntity() {
	}

	public NodeMemoryEntity(NodeMemoryEntityPK pk,
	...
	public NodeMemoryEntity(NodeEntity nodeEntity,
			Integer deviceIndex,
			String deviceType,
			String deviceName) {
		this(new NodeMemoryEntityPK(
	...
	@EmbeddedId
	public NodeMemoryEntityPK getId() {
		return this.id;
	}

	public void setId(NodeMemoryEntityPK id) {
		this.id = id;
	}
	...
	public void relateToNodeEntity(NodeEntity nodeEntity) {
		...
		if (nodeEntity != null) {
			List<NodeMemoryEntity> list = nodeEntity.getNodeMemoryEntities();
			if (list == null) {
				list = new ArrayList<NodeMemoryEntity>();
			} else {
				for(NodeMemoryEntity entity : list){
			...
			list.add(this);
			nodeEntity.setNodeMemoryEntities(list);
		}
	}
	...
	public void unchain() {
		...
		if (this.nodeEntity != null) {
			List<NodeMemoryEntity> list = this.nodeEntity.getNodeMemoryEntities();
			if (list != null) {
