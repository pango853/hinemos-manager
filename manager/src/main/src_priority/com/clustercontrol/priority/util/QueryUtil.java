...
public class QueryUtil {
	...
	public static PriorityInfoEntity getPriorityInfoPK(String judgmentId) throws MonitorNotFound {
		HinemosEntityManager em = new JpaTransactionManager().getEntityManager();
		PriorityInfoEntity entity = em.find(PriorityInfoEntity.class, judgmentId, ObjectPrivilegeMode.READ);
		if (entity == null) {
